...
@section('title', 'Afegir Nova Cançó')
...
@section('content')
    ...
    <div class="container mt-5 pt-5">
        <h1 class="text-center mb-4">Afegir Nova Cançó</h1>

        <form action="{{ route('songs.store') }}" method="POST" class="custom-form">
            @csrf
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control custom-input" id="artist" name="artist" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control custom-input" id="duration" name="duration" min="1" required>
            </div>

            <button type="submit" class="btn btn-dark custom-btn">Afegir Cançó</button>
        </form>
    </div>
